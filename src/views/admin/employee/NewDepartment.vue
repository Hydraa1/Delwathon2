...
const arrOfTable =[
      {branch:"Delwathon Group", dept:"Computer"},
      {branch:"Delwathon Group", dept:"Information Technology"},
...
<template>
    <div class="p-4 md:container container-lg">
        <div class="flex  justify-between items-center">
            <h2 class="font-medium text-sm uppercase mt-4 md:mt-0">EMPLOYEE DEPARTMENTS</h2>
            <div class="[font-size:12px] mt-4 md:mt-0">Dashboard Manage Department</div>
        </div>
        <!--  -->
                        ...
                        <div class=" md:-p4 p-4">
                            ...
                            <div class="grid grid-col-1 md:grid-cols-1 mx-auto mt-2 md:p-3 p-2">
                               ...
                               <div class="w-full mt-4">
                                    <label for="" class="mb-4 text-[#4F4F4F] dark:text-inherit after:content-['*'] after:ml-0.5 after:text-red-500">Department</label>
                                    <input type="text" class="app-input w-full mt-1" placeholder="Department Name">
                               </div>
                            </div>
