...
const arrOfTable =[
      {branch:"Delwathon Group", designation_name:"Mr Alade Samuel"},
      {branch:"Delwathon Group", designation_name:"Mr Toyib"},
...
<template>
    <div class="p-4 md:container container-lg">
        <div class="flex  justify-between items-center">
            <h2 class="font-medium text-sm uppercase mt-4 md:mt-0">EMPLOYEE DESIGNATION</h2>
            <div class="[font-size:12px] mt-4 md:mt-0">Dashboard Manage Designation</div>
        </div>
        <!--  -->
                        ...
                        v-for="(data, i) of state.data" :key="i">
                            ...
                            <td class="px-6 py-4">
                                <div class="space-x-2 flex">
                                    ...
                                    <button  @click="removeBranch(data)" class="bg-red-300 hover:bg-red-600 hover:text-white transition h-7 w-7 rounded-lg text-red-700"><i class="bx bx-trash"></i></button>
                                </div>
                            </td>
                        ...
                        <div class=" md:-p4 p-4">
                            ...
                            <div class="grid grid-col-1 md:grid-cols-1 mx-auto mt-2 md:p-3 p-2">
                               ...
                               <div class="w-full mt-4">
                                    <label for="" class="mb-4 text-[#4F4F4F] dark:text-inherit after:content-['*'] after:ml-0.5 after:text-red-500">Designation Name</label>
                                    <input type="text" class="app-input w-full mt-1" placeholder="Designation Name">
                               </div>
                            </div>
